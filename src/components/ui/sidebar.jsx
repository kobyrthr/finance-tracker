...
const Sidebar = React.forwardRef((props, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          'fixed inset-y-0 z-10 rounded-r-lg h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear flex',
          side === 'left'
...
const SidebarMenuItem = React.forwardRef((props, ref) => {
  ...
  return (
    <li
      ...
      className={cn(
        'group/menu-item relative font-bold text-[16px] leading-[150%] tracking-[0px]',
        className
      )}
      {...rest}
    />
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button pl-8 flex w-full items-center gap-4 overflow-hidden rounded-r-xl text-left text-sm outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!p-4 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        ghost: 'hover:bg-transparent hover:text-grey-100',
      },
      size: {
        default: 'h-fit py-4 text-sm',
        sm: 'h-7 text-xs',
